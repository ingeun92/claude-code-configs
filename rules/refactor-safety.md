...
- Split multi-file refactors into phases of 5 files or fewer. Complete each phase, run verification, and wait for explicit user approval before proceeding to the next. In autonomous execution (user-approved unattended runs), a passing verification for the phase substitutes for explicit user approval.
